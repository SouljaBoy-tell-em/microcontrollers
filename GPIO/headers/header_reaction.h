...
#define REG_RCC_CFGR_SELECT_SYSCLK_SOURCE                                 0x8U
#define REG_RCC_CFGR_SELECT_SYSCLK_MASK                                   0xCU
#define REG_RCC_CFGR_START                                         0x00010000U
#define REG_RCC_CFGR_TO_APB                                      (0b111U << 8U)
#define REG_RCC_CFGR_STAB1                                                0xCU
#define REG_RCC_CR_ENABLE_PLL_ON                                   0x02000000U
...
#define WHILE_STATE_ESTABLISHMENT(reg, start, end)                        \
        while(((*reg) & start) != (end));
